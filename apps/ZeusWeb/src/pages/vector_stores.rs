                ...
                <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,60,20,0.15); border-radius: 12px; padding: 20px; margin-bottom: 20px;">
                    ...
                    <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                        ...
                        <button
                            ...
                            on:click=do_create
                            style="padding: 10px 20px; background: rgba(255,60,20,0.2); border: 1px solid rgba(255,60,20,0.5); border-radius: 8px; color: rgba(255,140,80,1); font-size: 13px; cursor: pointer;"
                            ...
                            <div>
                                ...
                                <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,60,20,0.15); border-radius: 12px; padding: 20px; margin-bottom: 16px;">
                                    ...
                                    <div style="display: flex; gap: 10px;">
                                        ...
                                        <button
                                            ...
                                            on:click=do_search
                                            style="padding: 10px 20px; background: rgba(255,60,20,0.15); border: 1px solid rgba(255,60,20,0.4); border-radius: 8px; color: rgba(255,140,80,1); font-size: 13px; cursor: pointer;"
                                ...
                                <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,60,20,0.15); border-radius: 12px; padding: 20px; margin-bottom: 16px;">
                                    ...
                                    <div style="display: flex; gap: 10px;">
                                        ...
                                        />
                                        <button
                                            disabled=move || adding_file.get()
                                            on:click=do_add_file
                                            style="padding: 10px 20px; background: rgba(255,60,20,0.15); border: 1px solid rgba(255,60,20,0.4); border-radius: 8px; color: rgba(255,140,80,1); font-size: 13px; cursor: pointer;"
                                        >{move || if adding_file.get() { "Adding..." } else { "Add File" }}</button>
                                    </div>
                                </div>
