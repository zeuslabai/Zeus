                        ...
                        let agent_id2 = a.id.clone();
                            ...
                            <div>
                                ...
                                <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 24px;">
                                    ...
                                    <button
                                        on:click=move |_| show_detail.set(None)
                                ...
                                <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                                    ...
                                    <button
                                        on:click={let aid = agent_id2.clone(); move |_| {
                                            let url = format!("/studio?agent_id={}", aid);
                                            let _ = web_sys::window().unwrap().location().assign(&url);
                                        }}
                                        style="font-family: 'Orbitron', monospace; font-size: 8px; letter-spacing: 2px; padding: 6px 14px; border-radius: 6px; cursor: pointer; background: transparent; border: 1px solid rgba(255,60,20,0.15); color: rgba(255,245,240,0.5); display: flex; align-items: center; gap: 6px;"
                                    ><Icon name="chat" size=12 /> " Chat"</button>
                                </div>
                            </div>
                        }.into_any()
                    }}
        ...
        <div style="padding: 32px;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
                ...
                <div style="display: flex; gap: 8px;">
                    <button
                        on:click=move |_| { rt_task.set(String::new()); rt_result.set(String::new()); show_run_task.set(true); }
                        style="font-family: 'Orbitron', monospace; font-size: 8px; letter-spacing: 2px; padding: 8px 14px; border-radius: 8px; cursor: pointer; background: rgba(234,179,8,0.1); border: 1px solid rgba(234,179,8,0.3); color: rgba(234,179,8,0.9);"
                    >"⚡ RUN TASK"</button>
                    <button
                        on:click=move |_| { team_name.set(String::new()); team_err.set(String::new()); show_team.set(true); }
                        style="font-family: 'Orbitron', monospace; font-size: 8px; letter-spacing: 2px; padding: 8px 14px; border-radius: 8px; cursor: pointer; background: rgba(168,85,247,0.1); border: 1px solid rgba(168,85,247,0.3); color: rgba(168,85,247,0.9);"
                    >"⬡ CREATE TEAM"</button>
                        ...
                        view! {
                            <Card glow=is_active>
                                ...
                                <div style="display: flex; gap: 4px;">
                                    <button
                                        style="font-family: 'Orbitron', monospace; font-size: 8px; letter-spacing: 1px; text-transform: uppercase; background: rgba(255,60,20,0.12); border: 1px solid rgba(255,60,20,0.35); color: rgba(255,140,80,1); padding: 5px 10px; border-radius: 6px; cursor: pointer; flex: 1;"
                                        on:click={let id = agent_id_task.clone(); move |_| show_task.set(Some(id.clone()))}
                                    >"Dispatch"</button>
                                    <button
                                        style="font-family: 'Orbitron', monospace; font-size: 8px; letter-spacing: 1px; text-transform: uppercase; background: rgba(59,130,246,0.08); border: 1px solid rgba(59,130,246,0.2); color: rgba(59,130,246,0.8); padding: 5px 10px; border-radius: 6px; cursor: pointer;"
                                        on:click={let id = agent_id_hire.clone(); move |_| { show_hire.set(Some(id.clone())); hire_task.set(String::new()); hire_result.set(String::new()); }}
                                    >"Hire"</button>
                                    <button
                                        style="font-family: 'Orbitron', monospace; font-size: 8px; letter-spacing: 1px; text-transform: uppercase; background: transparent; border: 1px solid rgba(255,60,20,0.1); color: rgba(255,245,240,0.7); padding: 5px 10px; border-radius: 6px; cursor: pointer; flex: 1;"
                                        on:click={let ad = agent_for_detail.clone(); move |_| show_detail.set(Some(ad.clone()))}
                                    >"Details"</button>
                                    <button
                                        style="font-family: 'Orbitron', monospace; font-size: 8px; letter-spacing: 1px; text-transform: uppercase; background: transparent; border: 1px solid rgba(255,60,20,0.1); color: rgba(255,245,240,0.7); padding: 5px 10px; border-radius: 6px; cursor: pointer;"
                                        on:click=move |_| {
                                            let _ = web_sys::window().unwrap().location().assign("/studio");
                                        }
                                    >"Chat"</button>
                                    <button
                                        style="font-family: 'Orbitron', monospace; font-size: 8px; letter-spacing: 1px; padding: 5px 8px; border-radius: 5px; cursor: pointer; background: rgba(239,68,68,0.06); border: 1px solid rgba(239,68,68,0.12); color: rgba(239,68,68,0.5);"
                                        on:click={let del_id = agent_id_del.clone(); move |_| {
