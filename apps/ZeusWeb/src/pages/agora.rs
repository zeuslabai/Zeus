                        ...
                        <div>
                            ...
                            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); gap: 12px; margin-bottom: 28px;">
                                {[
                                    ...
                                    let v = value.clone();
                                    view! {
                                        <div style="background: rgba(34,197,94,0.04); border: 1px solid rgba(34,197,94,0.1); border-radius: 12px; padding: 16px;">
                                    ...
                                    view! {
                                        <div style="margin-top: 20px; background: rgba(59,130,246,0.04); border: 1px solid rgba(59,130,246,0.2); border-radius: 12px; padding: 20px;">
                                            ...
                                            <div style="display: flex; gap: 10px; align-items: center;">
                                                ...
                                                <button
                                                    on:click=move |_| { hiring_selected.set(None); hiring_task.set(String::new()); hiring_result.set(String::new()); }
                                                    style="padding: 9px 16px; background: transparent; border: 1px solid rgba(255,245,240,0.08); border-radius: 8px; color: rgba(255,245,240,0.4); font-family: 'Orbitron', monospace; font-size: 9px; letter-spacing: 2px; cursor: pointer;"
                                                >"CANCEL"</button>
                                                {move || {
                ...
                <div>
                    ...
                    <div style="display: flex; gap: 10px; margin-bottom: 24px;">
                        ...
                        <button
                            ...
                            style="padding: 9px 20px; background: rgba(168,85,247,0.12); border: 1px solid rgba(168,85,247,0.3); border-radius: 8px; color: rgba(168,85,247,0.9); font-family: 'Orbitron', monospace; font-size: 9px; letter-spacing: 2px; cursor: pointer;"
                        >"LOOK UP"</button>
                    </div>
                            ...
                            <div style="max-width: 600px; margin: 0 auto;">
                                ...
                                <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px; margin-bottom: 20px;">
                                    {[
                                        ...
                                        let c = *color;
                                        view! {
                                            <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,245,240,0.07); border-radius: 12px; padding: 16px;">
                    ...
                    <div style="margin-bottom: 24px;">
                        <div style="display: flex; gap: 10px; align-items: center; margin-bottom: 10px;">
                            ...
                            <button
                                ...
                                style="padding: 9px 18px; background: rgba(255,60,20,0.12); border: 1px solid rgba(255,60,20,0.25); border-radius: 8px; color: rgba(255,140,80,0.9); font-family: 'Orbitron', monospace; font-size: 9px; letter-spacing: 2px; cursor: pointer;"
                            >"LOAD"</button>
                        </div>
                        {move || {
                    ...
                    <div style="position: fixed; inset: 0; background: rgba(0,0,0,0.7); z-index: 10000; display: flex; align-items: center; justify-content: center;"
                        ...
                        <div style="background: rgba(20,12,8,0.95); border: 1px solid rgba(255,60,20,0.25); border-radius: 16px; \
                            ...
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                                ...
                                <button style="background: none; border: none; color: rgba(255,245,240,0.5); font-size: 20px; cursor: pointer; padding: 4px 8px;"
                                    on:click=move |_| rating_skill.set(None)>
                                    "\u{2715}"
                                </button>
                            </div>
