    ...
    view! {
        <div>
            ...
            <div style="display: flex; gap: 10px; margin-bottom: 24px;">
                ...
                />
                <Button primary=true on_click=Some(Callback::new(move |_| do_search_click(leptos::ev::MouseEvent::new("click").unwrap())))>
        ...
        <div style="display: flex; gap: 24px; align-items: flex-start; flex-wrap: wrap;">
            ...
            <div style="flex: 1; min-width: 300px;">
                <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,60,20,0.15); border-radius: 12px; padding: 20px; margin-bottom: 16px;">
                    ...
                    <Button primary=true style="width: 100%;" on_click=Some(Callback::new(move |_| do_generate(leptos::ev::MouseEvent::new("click").unwrap())))>
