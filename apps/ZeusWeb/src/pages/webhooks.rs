        ...
        <div style="padding: 32px; max-width: 1100px; margin: 0 auto; font-family: 'Rajdhani', sans-serif; color: rgba(255,245,240,0.9);">
            ...
            {move || (active_tab.get() == 0).then(|| view! {
                <div>
                    <div style="display: flex; justify-content: flex-end; margin-bottom: 16px;">
                        <button
                            on:click=move |_| show_trigger.update(|v| *v = !*v)
                            style="padding: 9px 18px; background: rgba(255,60,20,0.15); border: 1px solid rgba(255,60,20,0.4); border-radius: 8px; color: rgba(255,140,80,1); font-family: 'Orbitron', monospace; font-size: 9px; letter-spacing: 2px; cursor: pointer;"
                        >"+ ADD TRIGGER"</button>
                    </div>
                    ...
                    {move || show_trigger.get().then(|| view! {
                        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,60,20,0.15); border-radius: 12px; padding: 20px; margin-bottom: 16px;">
                            ...
                            <button
                                disabled=move || creating_trig.get()
                                on:click=do_create_trigger
                                style="padding: 9px 20px; background: rgba(255,60,20,0.2); border: 1px solid rgba(255,60,20,0.5); border-radius: 8px; color: rgba(255,140,80,1); font-size: 13px; cursor: pointer;"
                            >{move || if creating_trig.get() { "Creating..." } else { "Create Trigger" }}</button>
                        </div>
                    })}
            ...
            {move || (active_tab.get() == 1).then(|| view! {
                <div>
                    <div style="display: flex; justify-content: flex-end; margin-bottom: 16px;">
                        <button
                            on:click=move |_| show_outbound.update(|v| *v = !*v)
                            style="padding: 9px 18px; background: rgba(255,60,20,0.15); border: 1px solid rgba(255,60,20,0.4); border-radius: 8px; color: rgba(255,140,80,1); font-family: 'Orbitron', monospace; font-size: 9px; letter-spacing: 2px; cursor: pointer;"
                    ...
                    {move || show_outbound.get().then(|| view! {
                        <div style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,60,20,0.15); border-radius: 12px; padding: 20px; margin-bottom: 16px;">
                            ...
                            <div style="display: flex; flex-direction: column; gap: 10px;">
                                ...
                                />
                                <button
                                    disabled=move || creating_out.get()
                                    on:click=do_create_outbound
                                    style="padding: 9px 20px; background: rgba(255,60,20,0.2); border: 1px solid rgba(255,60,20,0.5); border-radius: 8px; color: rgba(255,140,80,1); font-size: 13px; cursor: pointer; align-self: flex-start;"
                                >{move || if creating_out.get() { "Registering..." } else { "Register" }}</button>
                            </div>
                        </div>
                    })}
