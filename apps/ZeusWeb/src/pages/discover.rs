    ...
    view! {
        <div style="padding: 32px; font-family: 'Rajdhani', sans-serif; max-width: 1100px;">
            ...
            <div style="display: flex; gap: 10px; margin-bottom: 24px; flex-wrap: wrap; align-items: center;">
                ...
                // Search button
                <button
                    on:click=move |_| run_discover()
                    style="font-family: 'Orbitron', monospace; font-size: 9px; letter-spacing: 2px; padding: 10px 18px; border-radius: 8px; cursor: pointer; background: rgba(255,60,20,0.12); border: 1px solid rgba(255,60,20,0.3); color: rgba(255,245,240,0.85);"
                >"SEARCH"</button>
                // Clear
                {move || {
                    ...
                    has_filter.then(|| view! {
                        <button
                            ...
                            style="font-family: 'Orbitron', monospace; font-size: 9px; letter-spacing: 1px; padding: 10px 14px; border-radius: 8px; cursor: pointer; background: transparent; border: 1px solid rgba(255,245,240,0.08); color: rgba(255,245,240,0.3);"
                        >"CLEAR"</button>
                    })
                }}
            </div>
