                                        ...
                                        view! {
                                            <div>
                                                ...
                                                <div style="display: flex; gap: 10px; margin-top: 18px; justify-content: flex-end;">
                                                    ...
                                                    >"CANCEL"</button>
                                                    <button
                                                        style=move || format!("font-family: 'Orbitron', monospace; font-size: 9px; letter-spacing: 2px; padding: 10px 22px; border-radius: 8px; cursor: {}; background: rgba(255,60,20,0.15); border: 1px solid rgba(255,60,20,0.35); color: #ff3c14; opacity: {};",
                ...
                <div style="display: flex; gap: 6px; flex-wrap: wrap;">
                    <button
                        style=move || format!("font-family: 'Orbitron', monospace; font-size: 9px; letter-spacing: 2px; padding: 8px 14px; border-radius: 6px; cursor: pointer; border: 1px solid {}; background: {}; color: {};",
                            ...
                            if sel_cat.get().is_empty() { "#ff3c14" } else { "rgba(255,245,240,0.6)" })
                        ...
                        view! {
                            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 14px;">
                                {list.into_iter().map(|t| {
                                    ...
                                    view! {
                                        <div
                                            style=format!("padding: 20px; border-radius: 12px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,60,20,0.1); display: flex; flex-direction: column; gap: 10px; cursor: pointer; transition: all 0.2s ease; border-left: 3px solid {};", col)
                                            on:mouseenter=|e| {
                                                use wasm_bindgen::JsCast;
                                                if let Some(el) = e.current_target().and_then(|t| t.dyn_into::<web_sys::HtmlElement>().ok()) {
                                                    let _ = el.style().set_property("background", "rgba(255,255,255,0.05)");
                                                }
                                            }
                                            on:mouseleave=|e| {
                                                use wasm_bindgen::JsCast;
                                                if let Some(el) = e.current_target().and_then(|t| t.dyn_into::<web_sys::HtmlElement>().ok()) {
                                                    let _ = el.style().set_property("background", "rgba(255,255,255,0.03)");
                                                }
                                            }
                                        >
                                            ...
                                            <button
                                                style="font-family: 'Orbitron', monospace; font-size: 9px; letter-spacing: 2px; padding: 9px 0; border-radius: 8px; cursor: pointer; background: rgba(255,60,20,0.1); border: 1px solid rgba(255,60,20,0.2); color: #ff3c14; transition: all 0.2s; width: 100%;"
                                                on:click=move |_| {
