...
fn channels() -> &'static [ChannelDef] {
    &[
        ...
        ChannelDef {
            ...
            pair: PairKind::None,
            fields: &[
                ChannelFieldDef { key: "server_url", label: "Server URL", placeholder: "https://mattermost.example.com", secret: false, required: true, default: None },
                ChannelFieldDef { key: "token", label: "Bot/Access Token", placeholder: "...", secret: true, required: true, default: None },
                ChannelFieldDef { key: "team_id", label: "Team ID", placeholder: "(optional)", secret: false, required: false, default: None },
            ],
        },
        ChannelDef {
            id: "mqtt",
            ...
            pair: PairKind::None,
            fields: &[
                ChannelFieldDef { key: "broker_url", label: "Broker Host", placeholder: "mqtt.example.com", secret: false, required: true, default: None },
                ChannelFieldDef { key: "port", label: "Port", placeholder: "1883", secret: false, required: true, default: Some("1883") },
                ChannelFieldDef { key: "topic_prefix", label: "Topic Prefix", placeholder: "zeus/", secret: false, required: false, default: None },
                ChannelFieldDef { key: "username", label: "Username", placeholder: "(optional)", secret: false, required: false, default: None },
                ChannelFieldDef { key: "password", label: "Password", placeholder: "(optional)", secret: true, required: false, default: None },
            ],
        },
        ChannelDef {
            id: "teams",
            ...
            pair: PairKind::None,
            fields: &[
                ChannelFieldDef { key: "tenant_id", label: "Tenant ID", placeholder: "azure-ad-tenant-id", secret: false, required: true, default: None },
                ChannelFieldDef { key: "client_id", label: "Client ID", placeholder: "azure-ad-app-id", secret: false, required: true, default: None },
                ChannelFieldDef { key: "client_secret", label: "Client Secret", placeholder: "...", secret: true, required: true, default: None },
                ChannelFieldDef { key: "team_id", label: "Team ID", placeholder: "(optional)", secret: false, required: false, default: None },
                ChannelFieldDef { key: "channel_id", label: "Channel ID", placeholder: "(optional)", secret: false, required: false, default: None },
            ],
        },
        ChannelDef {
            id: "webchat",
            ...
            pair: PairKind::None,
            fields: &[
                ChannelFieldDef { key: "websocket_path", label: "WebSocket Path", placeholder: "/ws/chat", secret: false, required: false, default: None },
                ChannelFieldDef { key: "auth_token", label: "Auth Token", placeholder: "(optional)", secret: true, required: false, default: None },
            ],
        },
        ChannelDef {
            id: "googlechat",
            ...
            pair: PairKind::None,
            fields: &[
                ChannelFieldDef { key: "credentials_path", label: "Credentials File", placeholder: "/path/to/service-account.json", secret: false, required: true, default: None },
                ChannelFieldDef { key: "project_id", label: "Project ID", placeholder: "(optional)", secret: false, required: false, default: None },
            ],
        },
        ChannelDef {
            id: "nextcloud",
            ...
            pair: PairKind::None,
            fields: &[
                ChannelFieldDef { key: "server_url", label: "Server URL", placeholder: "https://cloud.example.com", secret: false, required: true, default: None },
                ChannelFieldDef { key: "username", label: "Username", placeholder: "bot-user", secret: false, required: true, default: None },
                ChannelFieldDef { key: "password", label: "App Password", placeholder: "...", secret: true, required: true, default: None },
            ],
        },
        ChannelDef {
            ...
            pair: PairKind::None,
            fields: &[
                ChannelFieldDef { key: "private_key", label: "Private Key (hex or nsec)", placeholder: "nsec1... or hex", secret: true, required: true, default: None },
                ChannelFieldDef { key: "relay_urls", label: "Relay URLs (comma-sep)", placeholder: "wss://relay.damus.io,wss://nos.lol", secret: false, required: true, default: None },
            ],
        },
        ChannelDef {
            id: "line",
            ...
            pair: PairKind::None,
            fields: &[
                ChannelFieldDef { key: "channel_access_token", label: "Channel Access Token", placeholder: "...", secret: true, required: true, default: None },
                ChannelFieldDef { key: "channel_secret", label: "Channel Secret", placeholder: "(for webhook validation)", secret: true, required: false, default: None },
            ],
        },
        ChannelDef {
            id: "feishu",
            ...
            pair: PairKind::None,
            fields: &[
                ChannelFieldDef { key: "app_id", label: "App ID", placeholder: "cli_...", secret: false, required: true, default: None },
                ChannelFieldDef { key: "app_secret", label: "App Secret", placeholder: "...", secret: true, required: true, default: None },
                ChannelFieldDef { key: "verification_token", label: "Verification Token", placeholder: "(optional)", secret: true, required: false, default: None },
            ],
        },
        ChannelDef {
            id: "zalo",
            ...
            pair: PairKind::None,
            fields: &[
                ChannelFieldDef { key: "app_id", label: "App ID", placeholder: "...", secret: false, required: true, default: None },
                ChannelFieldDef { key: "secret_key", label: "Secret Key", placeholder: "...", secret: true, required: true, default: None },
                ChannelFieldDef { key: "access_token", label: "OA Access Token", placeholder: "(optional)", secret: true, required: false, default: None },
            ],
        },
        ChannelDef {
            id: "sms",
            ...
            pair: PairKind::None,
            fields: &[
                ChannelFieldDef { key: "account_sid", label: "Twilio Account SID", placeholder: "AC...", secret: false, required: true, default: None },
                ChannelFieldDef { key: "auth_token", label: "Auth Token", placeholder: "...", secret: true, required: true, default: None },
                ChannelFieldDef { key: "from_number", label: "From Number (E.164)", placeholder: "+14155551234", secret: false, required: true, default: None },
            ],
        },
        ChannelDef {
            id: "twilio_whatsapp",
            ...
            fields: &[
                ChannelFieldDef { key: "account_sid", label: "Twilio Account SID", placeholder: "AC...", secret: false, required: true, default: None },
                ChannelFieldDef { key: "auth_token", label: "Auth Token", placeholder: "...", secret: true, required: true, default: None },
                ChannelFieldDef { key: "whatsapp_number", label: "WhatsApp Number (E.164)", placeholder: "+14155238886", secret: false, required: true, default: None },
            ],
        },
        ChannelDef {
            id: "voice",
            ...
            fields: &[
                ...
                ChannelFieldDef { key: "auth_token", label: "Auth Token", placeholder: "...", secret: true, required: true, default: None },
                ChannelFieldDef { key: "from_number", label: "From Number (E.164)", placeholder: "+14155551234", secret: false, required: true, default: None },
                ChannelFieldDef { key: "webhook_base_url", label: "Webhook Base URL", placeholder: "https://your-tunnel.ngrok.io (optional)", secret: false, required: false, default: None },
            ],
        },
        ChannelDef {
            id: "bluebubbles",
            ...
            pair: PairKind::None,
            fields: &[
                ChannelFieldDef { key: "server_url", label: "Server URL", placeholder: "http://localhost:1234", secret: false, required: true, default: None },
                ChannelFieldDef { key: "password", label: "Server Password", placeholder: "...", secret: true, required: true, default: None },
            ],
        },
        ChannelDef {
            id: "imessage",
        ...
        ChannelDef {
            ...
            name: "X / Twitter",
            glyph: "X",
            sdk: "v2 API • OAuth 1.0a + OAuth 2.0",
            color: || theme::WHITE,
            pair: PairKind::None,
            fields: &[
                ChannelFieldDef { key: "bearer_token", label: "Bearer Token", placeholder: "AAAA...", secret: true, required: false, default: None },
                ChannelFieldDef { key: "consumer_key", label: "Consumer Key", placeholder: "...", secret: true, required: true, default: None },
                ChannelFieldDef { key: "consumer_key_secret", label: "Consumer Key Secret", placeholder: "...", secret: true, required: true, default: None },
                ChannelFieldDef { key: "access_token", label: "Access Token", placeholder: "...", secret: true, required: true, default: None },
                ChannelFieldDef { key: "access_token_secret", label: "Access Token Secret", placeholder: "...", secret: true, required: true, default: None },
                ChannelFieldDef { key: "client_id", label: "OAuth 2.0 Client ID", placeholder: "...", secret: true, required: false, default: None },
                ChannelFieldDef { key: "client_secret", label: "OAuth 2.0 Client Secret", placeholder: "...", secret: true, required: false, default: None },
            ],
        },
    ]
}
